...
Dir_data_X_GEN = 'G:\\My drive\\Paper\\GAN\\Data\\MMAGEN_New\\Possible Best Three Models For DRCA'
Dir_pretrained_model = 'G:\\My drive\\Paper\\GAN\\Model'
...
CF_X = np.load('Noisy0.2_Bi-GAN_HM2MMA_standardization_five layers_nonsaturating_separateGDE_dim300_epoch200_G initial_lr0.005_D initial_lr0.001_Grec initial_lr0.0001_beta1_alpha1.npy')
assert CF_X.shape[0] == 457
...
AF_Y = io.loadmat('MMA79_Y.mat')['label']
PAC_Y= io.loadmat('MMA_Tiernan_Y.mat')['label']
CF_Y = np.row_stack([AF_Y,PAC_Y])
assert CF_Y.shape[0] == 457
...
for D in components:
    for kernel_type in kernels:
        ...
        print('Current kernel: ',kernel_type)
        X_drca, X_test_drca = transform(Xs=X_std,Xt=X_test_std, dim=D,kernel_type=kernel_type)
